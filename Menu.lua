...
function oyom.CreateLib(oyoName, themeList)
	...
	TabScroll.Name = "tabScroiling"
	TabScroll.Parent = tabFrames
	TabScroll.BackgroundColor3 = themeList.Header
	TabScroll.BorderSizePixel = 0
	TabScroll.Position = UDim2.new(0.0438990258, 0, -0.00066378375, 0)
	TabScroll.Size = UDim2.new(0, 135, 0, 245)
	TabScroll.ScrollBarThickness = 5
	TabScroll.ScrollBarImageColor3 = Color3.fromRGB(themeList.SchemeColor.r * 255 - 16, themeList.SchemeColor.g * 255 - 15, themeList.SchemeColor.b * 255 - 28)
	
	tabListing.Name = "tabListing"
	tabListing.Parent = TabScroll
